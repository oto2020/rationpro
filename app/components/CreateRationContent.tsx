// components/CreateRationContent.tsx
"use client";
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-between mb-6">
                <div className="flex items-center">
                  <input
                    type="text"
                    placeholder="Салат с рукколой и помидорами"
...
export default CreateRationContent;
